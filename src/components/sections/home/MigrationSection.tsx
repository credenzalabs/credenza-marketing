              ...
              {[
                {
                  ...
                  body: "Import from Shopify or share a list. Credenza dedupes your contacts, groups them by firm, matches them to existing profiles, and enriches their data where available. Bulk-uploaded certificates are read, matched to the right client, and monitored for expiration.",
                },
                {
                  step: "02",
                ...
                },
                {
                  ...
                  body: "Request certificates from designers whose certs are missing, invalid, or expired—or start fresh and request new ones from all. They add a few details and Credenza generates a compliant certificate to review and sign.",
                },
              ].map((item) => (
