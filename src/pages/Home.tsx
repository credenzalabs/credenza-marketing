        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div style={{ transform: "scale(0.88) perspective(1200px) rotateY(-4deg) rotateX(2deg)", transformOrigin: "top right" }}>
            <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #e0dcd4", padding: "1.75rem", boxShadow: "0 12px 48px rgba(0,0,0,0.12), 0 2px 8px rgba(0,0,0,0.06)" }}>
              ...
              {/* Column headers */}
              <div className="grid gap-3 items-center px-1 mb-2" style={{ gridTemplateColumns: "1fr 100px 110px 60px 28px", fontFamily: "Inter, sans-serif", fontSize: "11px", color: "#6a6a62", textTransform: "uppercase" as const, letterSpacing: "0.06em" }}>
                <span>Label</span>
                <span>Discount %</span>
                <span>Order Min</span>
                <span>Base</span>
